...
export default {
  ...
  theme: {
    extend: {
      ...
      animation: {
        'edu-pulse': 'edu-pulse 2s ease-in-out infinite',
        'edu-float': 'edu-float 3s ease-in-out infinite',
      ...
      fontFamily: {
        ...
        'heading': ['Montserrat', 'Poppins', 'Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif'],
